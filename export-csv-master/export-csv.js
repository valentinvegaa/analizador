...
(function (Highcharts) {
    ...
    Highcharts.Chart.prototype.getDataRows = function () {
        ...
        var metadata='% Documento generado dinamicamente desde: </br> % fecha: '+f.getDate() + "/" + (f.getMonth() +1) + "/" + f.getFullYear()+'</br> % Autor: admin@ecoinformatica.cl </br> % Proyecto FONDEF D10I1038 </br> % Universidad Austral de Chile </br> % Laboratorio Ecoinformatica </br> % Esto fue generado por '+myip+'</br>';
    ...
    Highcharts.Chart.prototype.getCSV = function (useLocalDecimalPoint) {
        ...
        var metadata='% Documento generado dinamicamente desde: \n % fecha: '+f.getDate() + "/" + (f.getMonth() +1) + "/" + f.getFullYear()+'\n % Autor: admin@ecoinformatica.cl \n % Proyecto FONDEF D10I1038 \n % Universidad Austral de Chile \n % Laboratorio Ecoinformatica \n % Esto fue generado por '+myip+'\n';
        csv=metadata+csv;
        return csv;
    };
    ...
    function getContent(chart, href, extention, content, MIME) {
        var a,
            blobObject,
            name=Date.now()+' - '+'www.ecoinformatica.cl - admin@ecoinformatica.cl';
