...
function setAccumulatedYears($yearCount){
    $years=$yearCount?$yearCount:null;
    $result=array();
    $year=date('Y');
    $n=0;
    $last=0;
...
if($specie){
    ...
    if ($cached = cache_get($specie, 'cache')){
        ...
        $institutionNamesReuna=$results->getInstitucionReuna();//getInstitutionNames EN INGLÉS
